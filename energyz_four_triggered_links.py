...
def set_payer_energyz(IDM):
    ...
    apiUrl = "https://api.monday.com/v2"
    headers = {"Authorization" : apiKey}
    query = "mutation {change_multiple_column_values(item_id:"+str(IDM)+",board_id :1631185124, column_values: \"{\\\"statut0__1\\\" : {\\\"label\\\" : \\\"Payé\\\"}}\") {id}}" 
    data = {'query' : query}
    print("audit_payé")
    r = requests.post(url=apiUrl, json=data, headers=headers)
...
def set_payer_energyz2(IDM):
    ...
    apiUrl = "https://api.monday.com/v2"
    headers = {"Authorization" : apiKey}
    query = "mutation {change_multiple_column_values(item_id:"+str(IDM)+",board_id :1631185124, column_values: \"{\\\"statut0__1\\\" : {\\\"label\\\" : \\\"Payé acompte 2\\\"}}\") {id}}"
    data = {'query' : query}
...
def set_payer_energyz3(IDM):
    ...
    apiUrl = "https://api.monday.com/v2"
    headers = {"Authorization": apiKey}
    query = "mutation {change_multiple_column_values(item_id:"+str(IDM)+",board_id :1631185124, column_values: \"{\\\"statut0__1\\\" : {\\\"label\\\" : \\\"Payé acompte 3\\\"}}\") {id}}"
    data = {'query': query}
...
def set_payer_energyz4(IDM):
    ...
    apiUrl = "https://api.monday.com/v2"
    headers = {"Authorization": apiKey}
    query = "mutation {change_multiple_column_values(item_id:"+str(IDM)+",board_id :1631185124, column_values: \"{\\\"statut0__1\\\" : {\\\"label\\\" : \\\"Payé acompte 4\\\"}}\") {id}}"
    data = {'query': query}
